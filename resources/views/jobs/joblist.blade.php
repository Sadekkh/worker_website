                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" id="show-details"
                            ...
                            العمل</a>
                        @can('worker_tra')
                            <button data-href='{"id":{{ $dat->id }},"userid":{{ $dat->user_id }}}' type="button"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @can('worker')
                        <form id="sendmessage" method="post" action="{{ route('request.store') }}">
                        @endcan
                        @can('transporter')
                            <form id="sendmessage" method="post" action="{{ route('transport.store') }}">
                            @endcan
                            @csrf
