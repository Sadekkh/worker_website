                ...
                <tr>
                        ...
                        <td>
                            ...
                            @elseif($dat->accept == 1)
                                ...
                                <a href="javascript:void(0)" id="show-details"
                                    data-url="{{ route('jobs.details') }}"data-href='{"id":{{ $dat->job_id }},"userid":{{ $dat->user_id }}}''
                                    class="btn btn-info">التفاصيل</a>
                            @elseif($dat->accept == 2)
                                <button type="button" class="btn btn-secondary">ملغى</button>
                            @endif
                            @if ($dat->review == 0 && $dat->date_end < date('Y-m-d') && $dat->accept == 1)
                                <a href="javascript:void(0)" id="reviews"
                                    data-url="{{ route('jobs.details') }}"data-href='{"id":{{ $dat->job_id }},"userid":{{ $dat->emp_id }},"idd":{{ $dat->id }}}'
                    ...
                    @can('employer')
                        <td>
                            ...
                            @elseif($dat->state == 1 && $dat->date_end > date('Y-m-d'))
                                <button type="button" class="btn btn-success">في الإنجاز</button>
                            @elseif($dat->date_end < date('Y-m-d'))
                                <button type="button" class="btn btn-secondary">منتهي</button>
                            @endif
                            <a href="javascript:void(0)" id="show-details"
                                data-url="{{ route('jobs.details') }}"data-href='{"id":{{ $dat->id }},"userid":{{ $dat->user_id }}}'
                                class="btn btn-info">التفاصيل</a>
                        </td>
                    @endcan
                    <td></td>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="sendmessage" method="post" action="{{ route('review.store') }}">
