        ...
        <tbody>
            <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td> <a href="javascript:void(0)" id="show-user" data-url="<?php echo e(route('request.show', $dat->id)); ?>"
                            class="btn btn-info">معطيات حول العامل</a>
                        <?php if($dat->accept == 0): ?>
                            <form method="post" action="<?php echo e(route('request.accept', [$dat->job, $dat->jobid])); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\example-app - Copy\resources\views/requests/list.blade.php ENDPATH**/ ?>