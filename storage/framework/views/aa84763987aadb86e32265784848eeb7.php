...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <label for="" class="col-md-4 col-form-label text-md-end">رقم بطاقة التعريف</label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div id="transporterv" class="radiobox">
                                        <label for="transp_mat" value="الرقم المنجمي للسيارة" />الرقم المنجمي للسيارة
    ...
    <script>
        $("#dropdown").change(function() {
            ...
            if (value == 2) {
                $("#worker").show();
                document.getElementById("worker").required = true;

            } else if (value == 3) {
                $("#transporterv").show();
                document.getElementById("transp_mat").required = true;
                document.getElementById("transp_place").required = true;
        ...
        $("#worker").change(function() {
            ...
            if (value == 1)
                $("#workerin").show();
            document.getElementById("workerin").required = true;

        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\example-app - Copy\resources\views/auth/register.blade.php ENDPATH**/ ?>